...
{
    public sealed class Forge : Sledge
    {
        public Forge(Texture2D texture, int gridPosX, int gridPosY, float movementSpeed, Sledge nextSledge, Grid grid) :
        ...
        {
            var sledgeModel = new ForgeModel()
            {
