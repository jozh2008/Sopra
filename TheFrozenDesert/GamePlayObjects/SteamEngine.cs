...
{
    internal sealed class SteamEngine :Sledge
    {
        public SteamEngine(Texture2D texture, int gridPosX, int gridPosY, float movementSpeed, Sledge nextSledge, Grid grid) :
        ...
        public SteamEngine(SteamEngineModel model,
            GameState gameState,
            Texture2D texture2D,
            float movementSoeed,
            Grid grid) :
        ...
        {
            var sledgeModel = new SteamEngineModel()
            {
