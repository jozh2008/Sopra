...
{
    internal sealed class Workbench : Sledge
    {
        public Workbench(Texture2D texture, int gridPosX, int gridPosY, float movementSpeed, Sledge nextSledge, Grid grid) :
        ...
        public Workbench(CraftingSledgeModel model,
            GameState gameState,
            Texture2D texture2D,
            float movementSoeed,
            Grid grid) :
        ...
        {
            var sledgeModel = new CraftingSledgeModel()
            {
